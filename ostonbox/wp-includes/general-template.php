...
function get_search_form($echo = true) {
	...
	<div class="text-center"> <!-- <label class="screen-reader-text" for="s">' . __('Search for:'). '</label> -->
	<input type="text" class="input-large search-query" value="' . get_search_query() . '" name="s" id="s" />
